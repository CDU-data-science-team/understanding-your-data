...
description: |
  The CDU Data Science Team plan to discuss data accessibility in more depth in the Understanding Your Data meetings in the 28 October 2021 meeting. This page will detail those reflections and links.
author:
  - name: Zoë Turner
...
The Government Statistical Society (GSS) are doing a lot of [work around accessibility](https://gss.civilservice.gov.uk/news/accessibility-and-statistical-publications-what-do-you-want-to-know/) and the CDU Data Team wants to use these guidelines and promote them throughout the Trust and further. Consequently we'd like to dedicate the October meeting of Understanding Your Data to starting the conversations around accessibility. We have chosen this to be October in order to promote this within the Trust, to take account of summer holidays and to try to raise awareness of our interest with groups that may not necessarily have considered attending this meeting before, but who we would like to direct our thinking and approaches to working with data.
...
* alt text for charts and images (alternative text which is the written explanation of what a picture is showing)
...
Many of these have been inspired from GSS and from following individuals on Social Media, like Twitter, to learn about best practice and the difficulties different people face with data, analysis and visualisations.
